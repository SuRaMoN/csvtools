...
{
    csv_reader reader = csv_reader::new_without_header("testdata/simple.csv");
...
{
    csv_reader reader = csv_reader::new_without_header("testdata/simple_with_quoted_fields.csv");
    csv_reader::iterator i = reader.begin();
    csv_reader::iterator end = reader.end();
...
{
    csv_reader reader = csv_reader::new_from_string_without_header(L"\n\nabc,def\nhij,klm");
    BOOST_CHECK_MESSAGE(count_if(reader, constant(true)) == 2, "input should contain 2 lines");
}
...
{
    csv_reader reader = csv_reader::new_from_utf8_file_without_header("testdata/simple.csv");
    BOOST_CHECK(count_if(reader, constant(true)) == 2);
    reader.reset();
    BOOST_CHECK(count_if(reader, constant(true)) == 2);
}
...
{
    csv_reader reader = csv_reader::new_from_utf8_file_without_header("testdata/large_input_simple.csv");
...
{
    csv_reader reader = csv_reader::new_from_utf8_file_without_header("testdata/large_input_advanced.csv");
